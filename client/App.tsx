    ...
    <ErrorBoundary>
      ...
      <BrowserRouter>
        <Routes>
          ...
          />
          <Route
            path="/dashboard/ecommerce/catalog"
            element={
              <ProtectedRoute requiredPermission="addEditDeleteProducts">
                <ProductCatalog />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/dashboard/ecommerce/ordering"
            element={
              <PlaceholderPage
                title="In-App Ordering"
                description="Manage customer orders and order processing workflow."
                feature="Order management system"
              />
            }
          />
          ...
          />
          <Route
            path="/dashboard/ecommerce/feedback"
            element={
              <PlaceholderPage
          ...
          <Route
            path="/dashboard/wholesaler/bulk-orders"
            element={
              <PlaceholderPage
                title="Bulk Order Management"
                description="Manage large volume orders and delivery coordination."
                feature="Bulk order system"
              />
            }
          />
          <Route
            path="/dashboard/wholesaler/commissions"
            element={<CommissionManagement />}
          />
          <Route
            path="/dashboard/wholesaler/client-profitability"
            element={
              <PlaceholderPage
                title="Client Profitability"
                description="Analyze profit margins and ROI per client relationship."
          ...
          />
          <Route
            path="/dashboard/wholesaler/invoice-generator"
            element={<InvoiceGenerator />}
          />
          <Route
          ...
          />
          <Route
            path="/dashboard/wholesaler/salesman-commission"
            element={
              <PlaceholderPage
                title="Salesman Commission Tracking"
                description="Track and calculate sales commission payments."
                feature="Commission tracking"
              />
            }
          />
          ...
          />
          <Route
            path="/dashboard/wholesaler/multi-branch-transfers"
            element={
              <PlaceholderPage
          ...
          />
          <Route
            path="/dashboard/distributor/area-clients"
            element={
              <PlaceholderPage
          ...
          />
          <Route
            path="/dashboard/distributor/schemes-offers"
            element={
              <PlaceholderPage
                title="Scheme/Offer Management"
                description="Manage promotional schemes and offers."
          ...
          />
          <Route
            path="/dashboard/distributor/returns-replacement"
            element={
              <PlaceholderPage
                title="Return/Replacement Control"
                description="Manage product returns and replacements."
          ...
          />
          <Route
            path="/dashboard/distributor/client-invoicing"
            element={
              <PlaceholderPage
                title="Client Invoicing"
          ...
          />
          <Route
            path="/dashboard/trader/party-list"
            element={
              <PlaceholderPage
                title="Party List"
                description="Manage supplier and customer contact lists."
                feature="Party management"
              />
            }
          />
          ...
          />
          <Route
            path="/dashboard/trader/invoice-generator"
            element={
              <PlaceholderPage
                title="Invoice Generator"
          ...
          />
          <Route
            path="/dashboard/trader/scheme-handling"
            element={
              <PlaceholderPage
                title="Scheme Handling"
          ...
          />
          <Route
            path="/dashboard/trader/return-refund"
            element={
              <PlaceholderPage
                title="Return & Refund Logs"
                description="Manage product returns and refund processing."
                feature="Return management"
              />
            }
          />
